@echo off
echo *********************************
echo  StudentMain进程管理工具
echo  By Dylan Chen
echo *********************************
echo 1、杀死StudentMain监控进程
echo 2、重新启动StudentMain进程
echo.&echo.
set /p a=请输入1或2并回车:
...
Echo 正在启用StudentMain服务 - 该过程可能需要1分钟或更久
...
net start "U8WebPool"
Echo *********************************
Echo 正在启动学生端监控程序 StudentMain.exe
